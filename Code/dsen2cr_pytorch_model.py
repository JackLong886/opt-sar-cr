...
class StackedResnetModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.loss_names = ["cloud_adaptive", "target_reg", "CARL", "MAE", "RMSE", "eval_precision", "eval_recall",
                           "eval_f1"]
    ...
    def forward(self):
        ...
        self.declouded_RGB = torch.clamp(self.declouded[:, [3, 2, 1], ...] / 5, 0,
                                         1) * 2 - 1  # map values from [0, 5] to [-1, 1]
    ...
    def optimize_parameters(self):
        ...
        self.loss_cloud_adaptive = torch.norm(self.cloud_mask * (self.declouded - self.cloud_free) +  # cloudy area
                                              (1 - self.cloud_mask) * (self.declouded - self.cloudy),
                                              1) / N_tot  # cloud-free area
